...
async function query(collectionName: string) {
    var collection: any[] = storageService.load(collectionName)
    if (!collection) collection = []
    return Promise.resolve(collection)
}

async function get(collectionName: string, id: string) {
...
async function post(collectionName: string, item: any) {
    var collection = await query(collectionName)
...
async function put(collectionName: string, item: any) {
    var collection = await query(collectionName)
...
async function insert(collectionName: string, items: any[]) {
    var collection = await query(collectionName)
